...
function PostMgtPage()
{
    ...
    <div className="PostMgt">
        <div className="mainPostmgt" >
           <SearchBar children="Search Post" 
                    ...
                    {results?.map((key,index) =>
                    {
                        ...
                        <tr >
                            ...
                            <td style={{
                                ...
                                <Button type="primary" 
                                        className="editBtn"
                                        onClick={() => handleEdit(index,key.postText)}>
                                            Edit
                                        </Button>
                                ...
                                <Button onClick={()=> showReport(key.postID)} 
                                        className="reportBtn">
                                         View Report
                                         </Button>
                            </td>
        ...
        {showReportState && 
            <Report report={reportData} 
                    close={() => setShowReportState(false)}
            />}          
        </div>
    </div>
        );
